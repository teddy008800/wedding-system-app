...
export class LandingComponent implements OnInit, OnDestroy {
  ...
  private readonly themeStorageKey = 'wedding-theme-dark';
  ...
  ngOnInit(): void {
    const persistedTheme = window.localStorage.getItem(this.themeStorageKey);
    this.isDark = persistedTheme !== null
      ? persistedTheme === '1'
  ...
  private syncTheme(): void {
    ...
    window.localStorage.setItem(this.themeStorageKey, this.isDark ? '1' : '0');
  }
  ...
  protected get memoriesRoute(): string[] {
    return this.currentSlug ? ['/', this.currentSlug, 'memories'] : ['/'];
  }

  protected get hasWeddingSlug(): boolean {
